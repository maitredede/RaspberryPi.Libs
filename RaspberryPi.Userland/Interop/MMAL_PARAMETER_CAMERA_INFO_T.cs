...
namespace RaspberryPi.Userland.Interop
{
    ...
    internal struct MMAL_PARAMETER_CAMERA_INFO_T
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MMALNativeMethods.MMAL_PARAMETER_CAMERA_INFO_MAX_CAMERAS)]
        public MMAL_PARAMETER_CAMERA_INFO_CAMERA_T[] cameras;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = MMALNativeMethods.MMAL_PARAMETER_CAMERA_INFO_MAX_FLASHES)]
